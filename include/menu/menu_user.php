...
echo '
    ...
    <div class="ui-widget-content box_content">';
        ...
        array_push($user_menu_begin, array("nav_links" => "Host parent / child view::dependency.php", "friendly_name" => "Host parent / child view", "grouping" => ""));
        # create output
        ...
        if (!empty($ONCALL_GROUPS)){
            array_push($user_menu_begin2, array("nav_links" => "Change on-call settings::overview.php?class=contact&amp;xmode=pikett", "friendly_name" => "Change on-call settings", "grouping" => ""));
        }
        # Generate Nagios config link
        array_push($user_menu_begin2, array("nav_links" => "Generate Nagios config::generate_config.php", "friendly_name" => "Generate Nagios config", "grouping" => "", "icon" => "generate"));
