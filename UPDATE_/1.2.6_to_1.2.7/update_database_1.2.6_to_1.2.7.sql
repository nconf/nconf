...
INSERT INTO ConfigAttrs (attr_name, friendly_name, description, datatype, max_length, poss_values, predef_value, mandatory, ordering, visible, write_to_conf, naming_attr, link_as_child, link_bidirectional, fk_show_class_items, fk_id_class) VALUES
('servicegroups','assign advanced-service to servicegroup','','assign_many',0,'','','no',7,'yes','yes','no','no','yes',(SELECT id_class FROM ConfigClasses WHERE config_class='servicegroup'),(SELECT id_class FROM ConfigClasses WHERE config_class='advanced-service'));
INSERT INTO ConfigAttrs (attr_name, friendly_name, description, datatype, max_length, poss_values, predef_value, mandatory, ordering, visible, write_to_conf, naming_attr, link_as_child, link_bidirectional, fk_show_class_items, fk_id_class) VALUES
('use','service template(s)','parent template(s) to inherit from','assign_cust_order',0,'','','no',8,'yes','yes','no','no','no',(SELECT id_class FROM ConfigClasses WHERE config_class='service-template'),(SELECT id_class FROM ConfigClasses WHERE config_class='advanced-service'));
INSERT INTO ConfigAttrs (attr_name, friendly_name, description, datatype, max_length, poss_values, predef_value, mandatory, ordering, visible, write_to_conf, naming_attr, link_as_child, link_bidirectional, fk_show_class_items, fk_id_class) VALUES
('contact_groups','contact groups','responsible group','assign_many',0,'','','no',9,'yes','yes','no','no','no',(SELECT id_class FROM ConfigClasses WHERE config_class='contactgroup'),(SELECT id_class FROM ConfigClasses WHERE config_class='advanced-service'));
INSERT INTO ConfigAttrs (attr_name, friendly_name, description, datatype, max_length, poss_values, predef_value, mandatory, ordering, visible, write_to_conf, naming_attr, link_as_child, link_bidirectional, fk_show_class_items, fk_id_class) VALUES
('notes','notes','','text',1024,'','','no',10,'yes','yes','no','no','no',NULL,(SELECT id_class FROM ConfigClasses WHERE config_class='advanced-service'));
INSERT INTO ConfigAttrs (attr_name, friendly_name, description, datatype, max_length, poss_values, predef_value, mandatory, ordering, visible, write_to_conf, naming_attr, link_as_child, link_bidirectional, fk_show_class_items, fk_id_class) VALUES
('notes_url','notes URL','','text',1024,'','','no',11,'yes','yes','no','no','no',NULL,(SELECT id_class FROM ConfigClasses WHERE config_class='advanced-service'));
INSERT INTO ConfigAttrs (attr_name, friendly_name, description, datatype, max_length, poss_values, predef_value, mandatory, ordering, visible, write_to_conf, naming_attr, link_as_child, link_bidirectional, fk_show_class_items, fk_id_class) VALUES
('action_url','action URL','PNP URL (if installed)','select',0,'/nagios/html/pnp4nagios/index.php?host=$HOSTNAME$&srv=$SERVICEDESC$','','no',12,'yes','yes','no','no','no',NULL,(SELECT id_class FROM ConfigClasses WHERE config_class='advanced-service'));
INSERT INTO ConfigAttrs (attr_name, friendly_name, description, datatype, max_length, poss_values, predef_value, mandatory, ordering, visible, write_to_conf, naming_attr, link_as_child, link_bidirectional, fk_show_class_items, fk_id_class) VALUES
('max_check_attempts','max check attempts','number of times to retry checking','text',4,'','','no',13,'yes','yes','no','no','no',NULL,(SELECT id_class FROM ConfigClasses WHERE config_class='advanced-service'));
INSERT INTO ConfigAttrs (attr_name, friendly_name, description, datatype, max_length, poss_values, predef_value, mandatory, ordering, visible, write_to_conf, naming_attr, link_as_child, link_bidirectional, fk_show_class_items, fk_id_class) VALUES
('check_interval','check interval','number of [min.] between regularly scheduled checks','text',4,'','','no',14,'yes','yes','no','no','no',NULL,(SELECT id_class FROM ConfigClasses WHERE config_class='advanced-service'));
INSERT INTO ConfigAttrs (attr_name, friendly_name, description, datatype, max_length, poss_values, predef_value, mandatory, ordering, visible, write_to_conf, naming_attr, link_as_child, link_bidirectional, fk_show_class_items, fk_id_class) VALUES
('retry_interval','retry interval','number of [min.] to wait before scheduling a re-check','text',4,'','','no',15,'yes','yes','no','no','no',NULL,(SELECT id_class FROM ConfigClasses WHERE config_class='advanced-service'));
INSERT INTO ConfigAttrs (attr_name, friendly_name, description, datatype, max_length, poss_values, predef_value, mandatory, ordering, visible, write_to_conf, naming_attr, link_as_child, link_bidirectional, fk_show_class_items, fk_id_class) VALUES
('notification_interval','notification interval','number of [min.] to wait before re-notifying a contact','text',4,'','','no',16,'yes','yes','no','no','no',NULL,(SELECT id_class FROM ConfigClasses WHERE config_class='advanced-service'));
INSERT INTO ConfigAttrs (attr_name, friendly_name, description, datatype, max_length, poss_values, predef_value, mandatory, ordering, visible, write_to_conf, naming_attr, link_as_child, link_bidirectional, fk_show_class_items, fk_id_class) VALUES
('notification_options','notification options','possible values: w,u,c,r,f,s,[n]','text',20,'','','no',17,'yes','yes','no','no','no',NULL,(SELECT id_class FROM ConfigClasses WHERE config_class='advanced-service'));
INSERT INTO ConfigAttrs (attr_name, friendly_name, description, datatype, max_length, poss_values, predef_value, mandatory, ordering, visible, write_to_conf, naming_attr, link_as_child, link_bidirectional, fk_show_class_items, fk_id_class) VALUES
('active_checks_enabled','active checking','do active checking of services','select',0,'0::1','','no',18,'yes','yes','no','no','no',NULL,(SELECT id_class FROM ConfigClasses WHERE config_class='advanced-service'));
INSERT INTO ConfigAttrs (attr_name, friendly_name, description, datatype, max_length, poss_values, predef_value, mandatory, ordering, visible, write_to_conf, naming_attr, link_as_child, link_bidirectional, fk_show_class_items, fk_id_class) VALUES
('passive_checks_enabled','passive checking','do passive checking of services','select',0,'0::1','','no',19,'yes','yes','no','no','no',NULL,(SELECT id_class FROM ConfigClasses WHERE config_class='advanced-service'));
INSERT INTO ConfigAttrs (attr_name, friendly_name, description, datatype, max_length, poss_values, predef_value, mandatory, ordering, visible, write_to_conf, naming_attr, link_as_child, link_bidirectional, fk_show_class_items, fk_id_class) VALUES
('notifications_enabled','notification enabled','send notifications for services','select',0,'0::1','','no',20,'yes','yes','no','no','no',NULL,(SELECT id_class FROM ConfigClasses WHERE config_class='advanced-service'));
INSERT INTO ConfigAttrs (attr_name, friendly_name, description, datatype, max_length, poss_values, predef_value, mandatory, ordering, visible, write_to_conf, naming_attr, link_as_child, link_bidirectional, fk_show_class_items, fk_id_class) VALUES
('check_freshness','check freshness','check age of last check results','select',0,'0::1','','no',21,'yes','yes','no','no','no',NULL,(SELECT id_class FROM ConfigClasses WHERE config_class='advanced-service'));
INSERT INTO ConfigAttrs (attr_name, friendly_name, description, datatype, max_length, poss_values, predef_value, mandatory, ordering, visible, write_to_conf, naming_attr, link_as_child, link_bidirectional, fk_show_class_items, fk_id_class) VALUES
('freshness_threshold','freshness threshold','age threshold in [sec.]','text',5,'','','no',22,'yes','yes','no','no','no',NULL,(SELECT id_class FROM ConfigClasses WHERE config_class='advanced-service'));
INSERT INTO ConfigAttrs (attr_name, friendly_name, description, datatype, max_length, poss_values, predef_value, mandatory, ordering, visible, write_to_conf, naming_attr, link_as_child, link_bidirectional, fk_show_class_items, fk_id_class) VALUES
('check_params','params for check command','','text',1024,'','!','no',23,'yes','no','no','no','no',NULL,(SELECT id_class FROM ConfigClasses WHERE config_class='advanced-service'));
