...
$.fn.themeswitcher = function(settings){
	...
	function updateCSS(locStr){
        if (locStr == "#"){
            ...
            $("link[href*='jquery-ui.custom.css']:last").after('<link href="'+locStr+'" type="text/css" rel="Stylesheet" class="ui-theme" />');
            //$("link[href*=jquery-ui.custom.css]:last").after('<link href="/themeroller/css/parseTheme.css.php?'+ locStr +'" type="text/css" rel="Stylesheet" />');
            if( $("link.ui-theme").size() > 1){
                $("link.ui-theme").not(":first").remove();
            }	
            /*
